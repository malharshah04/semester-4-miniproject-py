...
class About:
    def __init__(self, master):
        ...
        self.master.geometry("765x488")
        self.frame = Frame(self.master)
        self.frame.pack()

        self.title_label = Label(self.frame, text="About Us", font=("Helvetica", 16, "bold"))
        self.title_label.pack(pady=10)

        self.info_label = Label(self.frame, text="Welcome to Jabardastly Smart Store!\n Shop no.11,12,13,14 Hari Darshan Near Suncity Cinema,\n Vile Parle(East)  \nWe are dedicated to providing high-quality products and services.\nThank you for visiting!", font=("Helvetica", 12))
